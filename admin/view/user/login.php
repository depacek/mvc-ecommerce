...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo base_url(); ?>public/index2.html"><b>Ecommerce Dashboard</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Sign in to access Ecommerece Dashard</p>
      ...
      <form action="" id="login_form" method="post">
        ...
        <div class="form-group has-feedback">
          <input type="password" class="form-control" name="password" placeholder="Password" title="enter email" required="">
