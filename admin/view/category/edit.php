...
<ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?php echo base_url() ?>category/index">ListCategory</a></li>
      ...
      <div class="card">
        <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">
                <a href="" class="btn btn-primary">Update Category</a> /
                <a href="<?php echo base_url() ?>category/create" class="btn btn-primary">Create Category</a>/<a href="<?php echo base_url() ?>category/index" class="btn btn-primary">List Category</a>
              </h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
